...
ComboBox::ComboBox(Border* border, short left, short top, vector<string> values) : Control(left, top, border), values(values), width(20), isOpen(FALSE), currentIndex(0)
{
	textBox = values[0];
}

ComboBox::ComboBox(Border * border, short left, short top, vector<string> values, Color backgroundColor, Color foregroundColor) : Control(left, top, border), values(values), width(20), isOpen(FALSE), currentIndex(0)
{
